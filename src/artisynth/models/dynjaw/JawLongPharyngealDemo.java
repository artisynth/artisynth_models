...
public class JawLongPharyngealDemo extends JawLarynxDemo{
   ...
   public void build (String[] args) throws IOException {
      ...
      /*
        ...
        JawModel.setPeckMaterial (m, maxForce, optLength, maxL, tendonRatio);
        setSpringDamping (m, muscleDamping);
   ...
   private void buildPalatopharyngeus(){
      ...
      JawModel.setPeckMaterial (
         lPphHigh, maxForce, optLength, maxL, tendonRatio);
      ...
      JawModel.setPeckMaterial (
         lPphLow, maxForce, optLength, maxL, tendonRatio);
      ...
      JawModel.setPeckMaterial (
         rPphHigh, maxForce, optLength, maxL, tendonRatio);
      ...
      JawModel.setPeckMaterial (
         rPphLow, maxForce, optLength, maxL, tendonRatio);
