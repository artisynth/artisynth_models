...
//      showMiddleLayer();
	 ...
	 addMuscles(face, faceGeometryDir + "face_muscles_yohan.node",midSagittalPlane);
      }
...
//      setNodesDynamicByNumber (face, "more_free_nodes_ansys.txt");
   ...
   public static void addMuscles(FemMuscleModel face, String muscleNodeFilename, double scale, Plane midSagittalPlane) {
	 ...
	 LinkedHashMap<Integer, Point3d> nodeMap = AnsysReader.readNodeFile(
         ...
         AnsysFaceMuscleFiberReader.read (face, nodeIdToIndex, new FileReader (
            faceGeometryDir + "face_muscles_topology.mac"));
      }
      catch (IOException e) {
         e.printStackTrace ();
      }
...
//      closeOOP();
   ...
   public static void addBilateralExciters(FemMuscleModel face) {
      ...
      String[] faceMuscleNames = new String[] {
...
//      String[] faceMuscleNames =
//         new String[] { "Triangulaire des levres ", "Buccinateur",
//                       "Carre du menton", "Houppe du menton", "Masseter",
//                       "Orbiculaire interne", "Orbiculaire externe",
//                       "Releveur aile du nez", "Releveur levre superieure",
//                       "Risorius", "Zygomatique" };
