...
{   
        ...
        ArrayList<String> cellData_vector_names, ArrayList<ArrayList<double[]>> cellData_vector_data)
    {
        ...
        try
        {
            ...
            for (int a=0; a<nCells; a++)
            {
                int nNodes = numNodes[a];
                file.printf("%d", nNodes);
                for (int b=0; b<nNodes; b++)
                    file.printf(" %d", fem.getElement(a).getNodes()[b].myNumber);
                file.println();
            }
   ...
   //*/
    ...
    public static FemModel3d readUnstructuredMesh_volume(String filename)
    {
       ...
       readUnstructuredMesh_volume (filename, fem);
       return fem;
    }
    
    public static void readUnstructuredMesh_volume(String filename, FemModel3d fem)
    {
        class Cell
        {
            int nPoints;
        ...
        {
            System.out.println("Error reading VTK file");
            return;
        }
    }
